...
\noindent
\ttfamily
\hlstd{CREATE\ TABLE\ IF\ NOT\ EXISTS\ `tbl\textunderscore user`\ (\hspace*{\fill}\\
}\hlstd{\ \ }\hlstd{`id`\ int(}\hlnum{11}\hlstd{)\ NOT\ NULL\ AUTO\textunderscore INCREMENT,\hspace*{\fill}\\
}\hlstd{\ \ }\hlstd{`username`\ varchar(}\hlnum{30}\hlstd{)\ COLLATE\ utf8\textunderscore bin\ NOT\ NULL,\hspace*{\fill}\\
}\hlstd{\ \ }\hlstd{`password`\ varchar(}\hlnum{255}\hlstd{)\ COLLATE\ utf8\textunderscore bin\ NOT\ NULL,\hspace*{\fill}\\
}\hlstd{\ \ }\hlstd{`email`\ varchar(}\hlnum{100}\hlstd{)\ COLLATE\ utf8\textunderscore bin\ DEFAULT\ NULL,\hspace*{\fill}\\
}\hlstd{\ \ }\hlstd{`is\textunderscore admin`\ tinyint(}\hlnum{1}\hlstd{)\ DEFAULT\ NULL,\hspace*{\fill}\\
}\hlstd{\ \ }\hlstd{`is\textunderscore paper`\ tinyint(}\hlnum{1}\hlstd{)\ DEFAULT\ NULL,\hspace*{\fill}\\
}\hlstd{\ \ }\hlstd{`is\textunderscore project`\ tinyint(}\hlnum{1}\hlstd{)\ DEFAULT\ NULL,\hspace*{\fill}\\
}\hlstd{\ \ }\hlstd{`is\textunderscore patent`\ tinyint(}\hlnum{1}\hlstd{)\ DEFAULT\ NULL,\hspace*{\fill}\\
}\hlstd{\ \ }\hlstd{PRIMARY\ KEY\ (`id`)\hspace*{\fill}\\
)\ ENGINE=InnoDB}\hlstd{\ \ }\hlstd{DEFAULT\ CHARSET=utf8\ COLLATE=utf8\textunderscore bin;}\hspace*{\fill}\\
\mbox{}
\normalfont
\normalsize
...
如图~\ref{pngprojecter.png}~所示，这是与科研项目有关的实体-关系图（ER图），图中展示了科研项目与实际执行人员的关系、科研项目与责任书人员的关系、学术论文与支柱科研项目的关系以及学术论文与报账科研项目之间的关系。
...
\pic[htbp]{对外显示界面}{width=1.0\textwidth}{pngindex.png}
...
\pic[htbp]{对内显示界面}{width=1.0\textwidth}{pngview.png}
...
%SELECT * FROM `tbl_project` `t` WHERE ((is_national=1) AND (start_date>'2010-01-01'))
\noindent
\ttfamily
\hlstd{SELECT\ {*}\ FROM\ `tbl\textunderscore project`\ `t`\ WHERE\ ((is\textunderscore national=}\hlnum{1}\hlstd{)\ AND\ (\Righttorque\hspace*{\fill}\\
